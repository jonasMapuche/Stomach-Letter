...
namespace Letter.Services.Interfaces
{
    public interface ISyntaxService
    {
        ...
        List<Lesson> PredicateDirectObject<T, TKey, TValue>(List<T> homeworks, Dictionary<(TKey, TValue), int> dictionaries, HashSet<string> vocabularies, List<Lesson> sources, int order_init) where TKey : notnull;
        ...
        List<Lesson> PredicatePredicative<T, TKey, TValue>(List<T> homeworks, Dictionary<(TKey, TValue), int> dictionaries, HashSet<string> vocabularies, List<Lesson> sources, int order_init) where TKey : notnull;
        ...
        List<Lesson> PredicateIndirectObject<T, TKey, TValue>(List<T> homeworks, Dictionary<(TKey, TValue), int> dictionaries, HashSet<string> vocabularies, List<Lesson> sources, int order_init) where TKey : notnull;
